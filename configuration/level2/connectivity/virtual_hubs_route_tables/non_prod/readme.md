...
rover \
  ...
  -var-folder /tf/caf/configuration/level2/connectivity/virtual_hubs_route_tables/non_prod \
  ...
  -level level2 \
  -w tfstate \
  -p ${TF_DATA_DIR}/connectivity_virtual_hubs_route_tables_non_prod.tfstate.tfplan \
  -a plan
